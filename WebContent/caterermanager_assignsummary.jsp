...
<h1 align = "center"> Assign Staff to Selected Event</h1>  
<table>  
...
<td><input type="text" name="Assigned_lname" value="${event.getAssigned_lname()}" disabled></td>
</tr>  

<tr>
<td>Assigned Staff First Name Items:</td>
<td><input type="text" name="Assigned_fname" value="${event.getAssigned_fname()}" disabled></td>
</tr>  

<tr><td colspan="2">
<a href="/catering_management/caterermanager_homepage.jsp"><input type="submit" class="button" value="Assign"></a></table>  
</form>  
