...
<form action = "/catering_management/UserController?action=modify_event" method = "post">
<table>  
...
<tr><td colspan="2"><input type="submit" value="Modify" onclick="if (confirm('Are you sure you want to modify?')) form.action='/catering_management/UserController?action=modify_event'; else form.action='/catering_management/UserController?action=cancelm';" /></td></tr>  
</table>  
</form>  
