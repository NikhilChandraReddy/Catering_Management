...
<form action="/catering_management/RegistrationController" method="post">
<input name="usernameError" value="<c:out value='${errorMsgs.errorMsg}' />" class="errorMsg" ><br>
<table style="width: 100%">
			<tr>
				<td>UserName (*):</td>
				<td><input name="username"  value="<c:out value='${registration.getUsername()}'/>" class="text16"></td>
 				<td> <input name="usernameError" value="<c:out value='${errorMsgs.usernameError}' />" class="errorMsg" > </td>
 				
			</tr>
			<tr>
				<td>Password (*):</td>
				<td><input type="password" name="password"  value="<c:out value='${registration.getPassword()}'/>" class="text16"></td>
 				<td> <input name="passwordError" value="<c:out value='${errorMsgs.passwordError}'/>" type="text" class="errorMsg"> </td>
			</tr>
			<tr>
				<td>Last Name (*):</td>
				<td><input name="last_name"  value="<c:out value='${registration.getLastName()}'/>" class="text16"></td>
 				<td> <input name="last_nameError" value="<c:out value='${errorMsgs.last_nameError}'/>" class="errorMsg"> </td>
			</tr>
			<tr>
				<td>First Name (*):</td>
				<td><input type="text" name="first_name" value="<c:out value='${registration.getFirstName()}'/>" class="text16" ></td>
			...
			<tr>
				...
				<td> <input name="roleError" value="<c:out value='${errorMsgs.roleError}'/>" type="text" class="errorMsg"> </td>	
			</tr> 			
			<tr>
				<td>UTA ID (*):</td>
				<td><input type="text" name="uta_id" value="<c:out value='${registration.getUtaId()}'/>" class="text16" /></td>
				<td> <input name="utaIDError" value="<c:out value='${errorMsgs.utaIDError}'/>" type="text" class="errorMsg"> </td>
			</tr>
			<tr>
				<td>Phone (*) :</td>
				<td><input type="text" name="phone" value="<c:out value='${registration.getPhone()}'/>" class="text16" /></td>
 				<td> <input name="phoneError" value="<c:out value='${errorMsgs.phoneError}'/>" type="text" class="errorMsg"> </td>
			</tr>			
			<tr>
				<td>Email (*):</td>
				<td><input type="text" name="email" value="<c:out value='${registration.getEmail()}'/>" class="text16" /></td>
 				<td> <input name="emailError" value="<c:out value='${errorMsgs.emailError}'/>" type="text" class="errorMsg"> </td>
			</tr>
			<tr>
				<td> Street Number (*):</td>
				<td><input type="text" name="street_number" value="<c:out value='${registration.getStreet_Number()}'/>" class="text16" /></td>
 				<td> <input name="street_numberError" value="<c:out value='${errorMsgs.street_numberError}'/>" class="errorMsg"> </td>
			</tr>
			<tr>
				<td> Street Name (*):</td>
				<td><input type="text" name="street_name" value="<c:out value='${registration.getStreet_Name()}'/>" class="text16" /></td>
 				<td> <input name="street_nameError" value="<c:out value='${errorMsgs.street_nameError}'/>" class="errorMsg"> </td>
			</tr>		
			<tr>
				<td> City (*):</td>
				<td><input type="text" name="city" value="<c:out value='${registration.getCity()}'/>" class="text16" /></td>
 				<td> <input name="cityError" value="<c:out value='${errorMsgs.cityError}'/>" class="errorMsg"> </td>
			</tr>	

			<tr>
				<td> State (*):</td>
				<td><input type="text" name="state" value="<c:out value='${registration.getState()}'/>" class="text16"/></td>
 				<td> <input name="stateError" value="<c:out value='${errorMsgs.stateError}'/>" class="errorMsg"> </td>
			</tr>
			<tr>
				<td> Zip Code (*):</td>
				<td><input type="text" name="zip_code" value="<c:out value='${registration.getZipCode()}'/>" class="text16" /></td>
